...
data:extend({
    ...
    recipe("sb-bee-house", "sb-general", 5, "sb-honey-comb", items("sb-wooden-frame", 1, "sb-worker-bee", 1), items("sb-honey-comb", 5, "sb-broken-frame", 0.5)),

    recipe("advanced-crafting", "sb-general", 5, "sb-solid-fuel", items("sb-wax", 10), items("solid-fuel", 1)),

    recipe("sb-centrifuge", "sb-combs", 0.5, "sb-coal-piece", items("sb-coal-honey-comb", 1), items("sb-coal-piece", 1, "sb-coal-piece", 0.5, "sb-wax", 0.5)),
    recipe("sb-centrifuge", "sb-combs", 0.5, "sb-copper-nugget", items("sb-copper-honey-comb", 1), items("sb-copper-nugget", 1, "sb-copper-nugget", 0.5, "sb-wax", 0.5)),
    recipe("sb-centrifuge", "sb-combs", 0.5, "sb-iron-nugget", items("sb-iron-honey-comb", 1), items("sb-iron-nugget", 1, "sb-iron-nugget", 0.5, "sb-wax", 0.5)),
    recipe("sb-centrifuge", "sb-combs", 0.5, "sb-stone-piece", items("sb-stone-honey-comb", 1), items("sb-stone-piece", 1, "sb-stone-piece", 0.5, "sb-wax", 0.5)),
    recipe("sb-centrifuge", "sb-combs", 0.5, "sb-uranium-nugget", items("sb-uranium-honey-comb", 1), items("sb-uranium-nugget", 1, "sb-uranium-nugget", 0.5, "sb-wax", 0.5)),

    recipe("advanced-crafting", "sb-ores", 0.25, "sb-coal", items("sb-coal-piece", 3), items("coal", 1)),
    recipe("advanced-crafting", "sb-ores", 0.25, "sb-copper-ore", items("sb-copper-nugget", 3), items("copper-ore", 1)),
    recipe("advanced-crafting", "sb-ores", 0.25, "sb-iron-ore", items("sb-iron-nugget", 3), items("iron-ore", 1)),
    recipe("advanced-crafting", "sb-ores", 0.25, "sb-stone", items("sb-stone-piece", 3), items("stone", 1)),
    recipe("crafting-with-fluid", "sb-ores", 0.25, "sb-uranium-ore", items("sb-uranium-nugget", 3, "sulfuric-acid", 2), items("uranium-ore", 1)),
    ...
    recipe("crafting", "sb-general", 1, "sb-repaired-frame", items("sb-broken-frame", 3), items("sb-wooden-frame", 1)),
